...
from hexrd.utilities.core.material.spacegroup import Allowed_HKLs, SpaceGroup
from hexrd.utilities.core import constants
from hexrd.utilities.core.material import symmetry, symbols
...
from hexrd.workflows.powder.wppf.xtal import (
    _calc_dspacing,
    _get_tth,
    _calcxrsf,
...
class Material_Rietveld:
    ...
    def InitializeInterpTable(self):
        ...
        data = importlib.resources.open_binary(
            hexrd.utilities.core.resources, 'Anomalous.h5'
        )

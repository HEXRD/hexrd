...
from hexrd.utilities.core.material.symbols import pstr_spacegroup
from hexrd.workflows.powder.wppf.phase import Phases_LeBail, Phases_Rietveld
from hexrd.utilities.core.material import Material
from hexrd.utilities.core.material.unitcell import _rqpDict
import hexrd
import numpy as np
...
def _add_detector_geometry(params, instr):
    ...
    """
    if isinstance(instr, hexrd.utilities.core.instrument.HEDMInstrument):

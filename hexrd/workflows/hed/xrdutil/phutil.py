...
from hexrd.utilities.core.instrument import Detector
...
def tth_corr_layer(panel, xy_pts,
    ...
    Parameters
    ----------
    panel : hexrd.utilities.core.instrument.Detector
        A panel instance.
    xy_pts : array_like
...
def tth_corr_map_layer(instrument,
    ...
    Parameters
    ----------
    instrument : hexrd.utilities.core.instrument.HEDMInstrument

...
from hexrd.utilities.core import constants as const
from hexrd.utilities.core import matrixutil as mutil
from hexrd.workflows.hedm import indexer
from hexrd.utilities.core import instrument
from hexrd.utilities.core.imageutil import find_peaks_2d
from hexrd.utilities.core import rotations as rot
from hexrd.utilities.core.transforms import xfcapi
from hexrd.workflows.hedm.xrdutil import EtaOmeMaps
...
def generate_eta_ome_maps(cfg, hkls=None, save=True):
    ...
    Parameters
    ----------
    cfg : hexrd.utilities.core.config.root.RootConfig

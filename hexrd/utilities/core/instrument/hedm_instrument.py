...
from hexrd.utilities.core.imageseries import ImageSeries
from hexrd.utilities.core.imageseries.process import ProcessedImageSeries
from hexrd.utilities.core.imageseries.omega import OmegaImageSeries
from hexrd.utilities.core.fitting.utils import fit_ring
from hexrd.utilities.core.gridutil import make_tolerance_grid
from hexrd.utilities.core import matrixutil as mutil
from hexrd.utilities.core.transforms.xfcapi import (
    angles_to_gvec,
    gvec_to_xy,
    make_sample_rmat,
    make_rmat_of_expmap,
...
from hexrd.workflows.hed.xrdutil import _project_on_detector_plane
from hexrd.utilities.core.material.crystallography import PlaneData
from hexrd.utilities.core import constants as ct
from hexrd.utilities.core.rotations import mapAngle
from hexrd.utilities.core import distortion as distortion_pkg
from hexrd.utilities.core.utils.concurrent import distribute_tasks
from hexrd.utilities.core.utils.hdf5 import unwrap_dict_to_h5, unwrap_h5_to_dict
from hexrd.utilities.core.utils.yaml import NumpyToNativeDumper
from hexrd.utilities.core.valunits import valWUnit
from hexrd.workflows.powder.wppf import LeBail
...
from hexrd.workflows.powder.wppf import wppfsupport
...
def _parse_imgser_dict(imgser_dict, det_key, roi=None):
    ...
    Returns
    -------
    ims : hexrd.utilities.core.imageseries
...
def max_tth(instr):
    ...
    Parameters
    ----------
    instr : hexrd.workflows.hedm.instrument.HEDMInstrument instance
    ...
    * where should reference eta be defined? currently set to default config
    ...
    def extract_line_positions(
        ...
        fitting_kwargs : dict, optional
            kwargs passed to hexrd.utilities.core.fitting.utils.fit_ring if do_fitting is True

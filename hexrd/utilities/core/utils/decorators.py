...
in :mod:`hexrd.utilities.core.utils`. Before putting something here please see if it should
go into another topical module in :mod:`hexrd.utilities.core.utils`.
"""
...
def _make_hashable(items):
    ...
    def convert(x):
        ...
        if isinstance(x, np.ndarray):
            ...
            return ('__type_np.ndarray', x.shape, xxhash.xxh3_128_hexdigest(x))

...
class PowderCalibrator(Calibrator):
    ...
    def __init__(
        ...
        self.pktype = pktype
        self.bgtype = bgtype
        # Optional dict of {alpha0, alpha1, beta0, beta1} that, if provided
        # alongside pktype == 'pink_beam_dcs', is applied to every peak in
        # every ring's fit with vary=False. Typically populated from a prior
        # WPPF (pvpink) refinement.

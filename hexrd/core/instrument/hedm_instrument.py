...
from ...hed.instrument.detector import beam_energy_DFLT, max_workers_DFLT
from ...hedm.instrument.detector import beam_energy_DFLT, max_workers_DFLT
from ...laue.instrument.detector import beam_energy_DFLT, max_workers_DFLT
from ...powder.instrument.detector import beam_energy_DFLT, max_workers_DFLT

...
import numpy as np
from hexrd.utilities.core.transforms.new_capi.xf_new_capi import angles_to_gvec
...
# def test_correct_angles_to_gvec(test_data_dir):
#     arr = [];
...
#     np.save(test_data_dir / "test_correct_angles_to_gvec.npy", arr)

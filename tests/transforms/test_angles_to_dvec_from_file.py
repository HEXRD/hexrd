...
# Loading to test correctness of dvec_to_xy
...
def test_angles_to_dvec_from_file(test_data_dir):
    ...
    arr = np.load(
        test_data_dir / 'test_correct_angles_to_dvec.npy',
        allow_pickle=True
    )
...
#     np.save("test_correct_angles_to_dvec.npy", arr)
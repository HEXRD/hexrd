...
if __name__ == '__main__':
    ...
    parser.add_argument('cfg_file',
                        help="yaml HEDM config filename",
                        type=str)
    parser.add_argument('gt_ref',
                        help="reference grain table filename",
                        type=str)

    parser.add_argument('-m', '--misorientation',

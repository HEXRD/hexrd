...
class TestFindOrientationsConfig(TestConfig):
    ...
    def test_threshold(self):
        self.assertEqual(self.cfgs[0].find_orientations.threshold, 1)
        self.assertEqual(self.cfgs[1].find_orientations.threshold, 5)
        self.assertEqual(self.cfgs[2].find_orientations.threshold, 5)

    def test_use_quaternion_grid(self):
        self.assertEqual(
            self.cfgs[0].find_orientations.use_quaternion_grid, None
        )
        self.assertRaises(
            IOError,
            getattr,
            self.cfgs[1].find_orientations,
            'use_quaternion_grid',
        )
        self.assertEqual(
...
class TestClusteringConfig(TestConfig):
    ...
    def test_algorithm(self):
        self.assertEqual(
            self.cfgs[0].find_orientations.clustering.algorithm, 'dbscan'
        )
        self.assertEqual(
            self.cfgs[1].find_orientations.clustering.algorithm, 'sph-dbscan'
        )
        self.assertEqual(
            self.cfgs[2].find_orientations.clustering.algorithm, 'fclusterdata'
        )
        self.assertRaises(
            RuntimeError,
            getattr,
            self.cfgs[3].find_orientations.clustering,
            'algorithm',
        )
    ...
    def test_completeness(self):
        self.assertRaises(
            RuntimeError,
            getattr,
            self.cfgs[0].find_orientations.clustering,
            'completeness',
        )
        self.assertEqual(
            self.cfgs[1].find_orientations.clustering.completeness, 0.35
        )
    ...
    def test_radius(self):
        ...
        self.assertEqual(self.cfgs[1].find_orientations.clustering.radius, 1.0)
...
class TestOmegaConfig(TestConfig):
    ...
    def test_period(self):
        self.assertEqual(
            self.cfgs[0].find_orientations.omega.period, [-180, 180]
        )
        self.assertEqual(self.cfgs[1].find_orientations.omega.period, [0, 360])
    ...
    def test_tolerance(self):
        ...
        self.assertEqual(self.cfgs[1].find_orientations.omega.tolerance, 1.0)
        self.assertEqual(self.cfgs[2].find_orientations.omega.tolerance, 3.0)
...
class TestEtaConfig(TestConfig):
    ...
    def test_tolerance(self):
        self.assertEqual(self.cfgs[0].find_orientations.eta.tolerance, 0.5)
        self.assertEqual(self.cfgs[1].find_orientations.eta.tolerance, 2.0)

    def test_mask(self):
        self.assertEqual(self.cfgs[0].find_orientations.eta.mask, 5)
        self.assertEqual(self.cfgs[1].find_orientations.eta.mask, 10)
        self.assertEqual(self.cfgs[2].find_orientations.eta.mask, 10)
...
class TestSeedSearchConfig(TestConfig):
    ...
    def test_hkl_seeds(self):
        ...
        self.assertEqual(
            self.cfgs[2].find_orientations.seed_search.hkl_seeds, [1]
        )
        self.assertEqual(
    ...
    def test_fiber_step(self):
        ...
        self.assertEqual(
            self.cfgs[1].find_orientations.seed_search.fiber_step, 1.0
        )
...
class TestOrientationMapsConfig(TestConfig):
    ...
    def test_active_hkls(self):
        self.assertEqual(
            self.cfgs[0].find_orientations.orientation_maps.active_hkls, None
        )
        self.assertEqual(
            self.cfgs[1].find_orientations.orientation_maps.active_hkls, [1]
        )
        self.assertEqual(
    ...
    def test_bin_frames(self):
        self.assertEqual(
            self.cfgs[0].find_orientations.orientation_maps.bin_frames, 1
        )
        self.assertEqual(
            self.cfgs[1].find_orientations.orientation_maps.bin_frames, 2
        )
    ...
    def test_threshold(self):
        ...
        self.assertEqual(
            self.cfgs[1].find_orientations.orientation_maps.threshold, 100
        )
